...
For detailed information about how LocalBot serves different user groups, see:
- [Skills System](./docs/SKILLS_SYSTEM.md) - Comprehensive list of tools and capabilities
- [Automation Processes](./docs/AUTOMATION_PROCESSES.md) - Detailed business and home automation workflows
- [Custom Skills and Models Guide](./docs/CUSTOM_SKILLS_AND_MODELS_GUIDE.md) - Instructions for extending LocalBot functionality
- [Architecture Overview](./docs/ARCHITECTURE_OVERVIEW.md) - Technical architecture and design principles
