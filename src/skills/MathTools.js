...
exports.StatisticsTool = exports.UnitConversionTool = exports.MathCalculationTool = void 0;
const Logger_1 = require("../utils/Logger");
class MathCalculationTool {
    constructor() {
        this.name = 'math_calculate';
        ...
        try {
            ...
            if (expression) {
                ...
                try {
                    ...
                    return { success: false, error: `Expression evaluation error: ${evalError.message}` };
                }
            }
            if (operation) {
            ...
            Logger_1.Logger.error(`Math calculation failed`, { error: error.message });
    ...
    evaluateExpression(expr) {
        ...
        Logger_1.Logger.warn('Expression evaluation is simplified for safety. Use specific operations for production.');
        return 0; // Placeholder - in real implementation, evaluate the expression
    }
}
exports.MathCalculationTool = MathCalculationTool;
class UnitConversionTool {
    constructor() {
        this.name = 'unit_conversion';
        this.description = 'Convert between different units of measurement';
        this.category = 'system';
    }
    async execute(params) {
        try {
            ...
            Logger_1.Logger.error(`Unit conversion failed`, { error: error.message });
            return { success: false, error: error.message };
        }
    }
}
exports.UnitConversionTool = UnitConversionTool;
class StatisticsTool {
    constructor() {
        this.name = 'statistics_calculate';
        this.description = 'Calculate statistical measures for a dataset';
        this.category = 'system';
    }
    async execute(params) {
        try {
            ...
            Logger_1.Logger.error(`Statistics calculation failed`, { error: error.message });
            return { success: false, error: error.message };
        }
    }
}
